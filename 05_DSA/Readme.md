...
Notes and resources from the DSA track of 100xSchool Bootcamp 1.0.
...
- **`Resources`**
  ...
  - [DSA Orientation Slides](./Week_00_Orientation/100xSchool_dsa_orientation_slide.pdf)

---

### Week 1 : Introduction to C++

- **`Session Notes - C++ Fundamentals`**

  - [Setting Up C++ Environment](Week_01_Introduction_to_C++/01_Session_notes.md#1-setting-up-c-environment)
  - [Basic C++ Program Structure](Week_01_Introduction_to_C++/01_Session_notes.md#2-basic-c-program-structure)
  - [Variables and Data Types](Week_01_Introduction_to_C++/01_Session_notes.md#3-variables-and-data-types)
  - [Input and Output Operations](Week_01_Introduction_to_C++/01_Session_notes.md#4-input-and-output-operations)
  - [Operators in C++](Week_01_Introduction_to_C++/01_Session_notes.md#5-operators-in-c)
  - [Conditional Statements](Week_01_Introduction_to_C++/01_Session_notes.md#6-conditional-statements)
